        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 hover:scale-105 transition-all duration-300 shadow-lg shadow-black/20">
            ...
            <p className="text-white/80 mb-4 leading-relaxed">
              Full Stack Developer passionate about creating amazing web experiences with modern glassmorphism design.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="group text-white/70 hover:text-white transition-all duration-300 hover:scale-110 hover:drop-shadow-lg">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 hover:scale-105 transition-all duration-300 shadow-lg shadow-black/20">
            <h4 className="text-lg font-semibold mb-4 drop-shadow-md">Quick Links</h4>
