...
export default function Chatbot() {
  ...
  const sendToN8N = async (message: string) => {
    try {
      ...
      const response = await fetch('https://adityajakap.app.n8n.cloud/webhook-test/chatbot', {
        method: 'POST',
        headers: {
      ...
      try {
        ...
        return responseText || 'Sorry, I received an invalid response.'
      }

      return data.response || data.message || responseText || 'Sorry, I couldn\'t process that request.'
